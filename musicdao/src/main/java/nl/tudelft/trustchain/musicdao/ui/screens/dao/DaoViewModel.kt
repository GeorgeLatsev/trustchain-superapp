...
//            try {
//                val newDAO =
//                    getDaoCommunity().createBitcoinGenesisWallet(
//                        currentEntranceFee,
//                        currentThreshold,
//                        context
//                    )
...
//
//            daos.value =
//                wallets.associateWith { daoBlock ->
...
//                proposals = proposals,
//                members =
//                    blockData.SW_BITCOIN_PKS.zip(blockData.SW_TRUSTCHAIN_PKS).map {
//                        Member(
//                            it.first,
//                            it.second
//                        )
