...
import nl.tudelft.trustchain.musicdao.core.ipv8.PayoutStatusUpdateGossiper
...
class MusicGossipingService : Service() {
    ...
    @Inject
    lateinit var payoutStatusUpdateGossiper: PayoutStatusUpdateGossiper
    ...
    override fun onCreate() {
        ...
        payoutStatusUpdateGossiper.startGossip(scope)
        scope.launch {
