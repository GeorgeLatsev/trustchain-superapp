...
class PayoutServiceTest {
    ...
    @Test
    fun `init sets node address and payoutWalletAddress when payout node is enabled`() =
        runTest {
    ...
    @Test
    fun `init sets up payout node peer listener when payout node is not enabled`() =
        runTest {
