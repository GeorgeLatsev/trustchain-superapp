package nl.tudelft.trustchain.musicdao.ui.screens.server
 ...
 class ServerPayoutDetailScreenViewModelTest {
     ...
     @Test
     fun `getContributionsForPayout returns correct flow from dao`() = runTest {
     ...
     @Test
     fun `getArtistPayouts returns correct flow from dao`() = runTest {
         val payoutId = "payout-2"
         val artistPayouts = listOf(
     ...
     @Test
     fun `getPayoutStatus returns correct status from dao`() = runTest {
     ...
     @Test
     fun `setPayoutStatus calls payoutManager and returns status`() = runTest {
